...
class mod_smartclassroom_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('static', 'label1', 'smartclassroomsetting1', 'Your smartclassroom fields go here. Replace me!');

        $mform->addElement('header', 'smartclassroomfieldset', get_string('smartclassroomfieldset', 'smartclassroom'));
