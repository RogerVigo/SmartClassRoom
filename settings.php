...
//$ADMIN->add('userinterface', new admin_externalpage('schools', get_string('schools', 'smartclassroom'),$CFG->wwwdir . '/' . 'mod/smartclassroom/schools.php'));
//$ADMIN->add('userinterface', new admin_settingpage('schools', get_string('schools', 'smartclassroom')));
...
$settings = new admin_settingpage('schools', get_string('schools', 'smartclassroom'));
